...
#define ROS_NODE_NAME   "esp32_controller"
#define ROS_PUB_TOPIC   "zlac_encoder"   // pub: std_msgs/Int32MultiArray [fb_left_rpm, fb_right_rpm]
#define ROS_SUB_TOPIC   "wheel_rpm"      // sub: std_msgs/Int32MultiArray [left_rpm, right_rpm]
...
#define STACK_SIZE      4096    // Modbus + Serial + snprintf safety margin
...
const int rcPin6        = 23;  // CH6: Mode Switch (LOW = ROS mode, HIGH = RC manual override)
#define LED_PIN           12
#define Manual            19
#define Auto              21
#define MAX485_DE         32
...
// ==================================================
// CH6 MODE SWITCH THRESHOLD (Microseconds)
//   pw6 > ch6_threshold → RC manual override
//   pw6 ≤ ch6_threshold → ROS autonomous mode
// ==================================================
